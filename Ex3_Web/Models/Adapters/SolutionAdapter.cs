...
namespace Ex3_Web.Models.Adapters
{
    /// <summary>
    /// SolutionAdapter design pattern.
    /// </summary>
    public class SolutionAdapter : ISearchable<Position>
    {
        /// <summary>
        /// The maze instance.
        /// </summary>
        ...
        public SolutionAdapter(int row, int col, int startX, int startY, int endX,
            int endY,
        ...
        /// <param name="sp">state pool.</param>
        public SolutionAdapter(Maze maze, StatePool<Position> sp)
        {
            this.maze = maze;
            this.statePool = sp;
        }
